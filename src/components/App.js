...
import { InputText, InputTel, InputEmail } from "./Inputs";
import { ImageInput, ImageInputButton, ImageInputFile } from "./ImageInput";
						...
						<section class="fill-in_section js-collapsible">
							...
							<div class="js-collapsible-content">
								<div class="fill-in_items">
									<InputText id="full_name" label="Nombre completo" classInput="js-name" name="name" placeholder="Hermione Granger" />
									<InputText id="job" label="Puesto" classInput="js-job" name="job" placeholder="Front-end developer" />
									<ImageInput className="fiil-in_label" for="img-profile" label="Imagen de perfil" classInputContainer="fill-in_buttonImg-wrapper">
									...
									<InputTel id="phone" label="Teléfono" classInput="js-phone" name="phone" placeholder="+34 678334765" type="tel" minLength="9" pattern="^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$" />
									<InputEmail id="email" label="Email" classInput="js-email" name="email" placeholder="hermione-granger@gmail.com" type="email" pattern="^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$" />
									<InputText id="linkedin" label="Linkedin" classInput="js-linkedin" name="linkedin" placeholder="hermionegranger" type="text" />
									<InputText id="github" label="Github" classInput="js-github" name="github" placeholder="hermione-granger" type="text" />
								</div>
							</div>
						</section>
